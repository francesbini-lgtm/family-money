...
const DEVLOG = [
  { date:'2026-07-14 02:10', desc:"Fix reale bug duplicazione accantonamenti Satispay (segnalato con screenshot dall'utente, splits x3 su una spesa Figli): linkOtherPot() faceva merge additivo senza mai rimpiazzare gli split del 'delta verso un altro fondo' — ora ogni split è taggato _potId e viene sostituito, non accodato, ad ogni re-link dello stesso fondo. Patrimonio: veicoli aggiunti automaticamente tra gli Attivi (usa il nuovo campo Valore di mercato), categorie 'Fondo Pensione'/'TFR' disponibili in + Aggiungi Attivo" },
  { date:'2026-07-14 01:45', desc:"Icone Satispay/PayPal anche negli header di pagina (BrandIcons.jsx condiviso); Uscite/Entrate: titolo sempre visibile sopra le tab (come Satispay); Veicolo: nuovi campi Modello/Carburante/Valore di mercato; Weekend e Vacanze: unico ⚙️ con tab Merchant/Prezzo Benzina (prima erano 2 bottoni separati, poco trovabile)" },
